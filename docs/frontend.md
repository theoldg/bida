...
server, unencrypted. Not stored.* — the one thing in the app that leaves the
phone readable, because the browser cannot call bunq itself. It is the same
admission `/about` makes about a receipt
